...
Indicator ID:   IND_PLD_RIC
Indicator Name: Plant Diversity — Richness count
Type:           TYPE A (ratio mode)

Description:
    Simple count of distinct plant strata or species.
...
INDICATOR = {
    "id": "IND_PLD_RIC",
    "name": "Plant Diversity — Richness count",
    "unit": "count",
    "formula": "",
    "target_direction": "INCREASE",
    "definition": "Simple count of distinct plant strata or species.",
    "category": "",
    "calc_type": "ratio",
    "target_classes": [],
}
