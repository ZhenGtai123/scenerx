...
Indicator ID:   IND_PLD_SIM
Indicator Name: Plant Diversity — Simpson 1-D
Type:           TYPE A (ratio mode)

Description:
    Simpson (1-D) diversity over plant-class proportions.
...
INDICATOR = {
    "id": "IND_PLD_SIM",
    "name": "Plant Diversity — Simpson 1-D",
    "unit": "ratio (0-1)",
    "formula": "",
    "target_direction": "INCREASE",
    "definition": "Simpson (1-D) diversity over plant-class proportions.",
    "category": "",
    "calc_type": "ratio",
    "target_classes": [],
}
